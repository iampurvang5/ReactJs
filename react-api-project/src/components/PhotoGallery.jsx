...
const PhotoGallery = ({ isDetailPage = false }) => {
	...
	return (
	<div className={`w-full ${isDetailPage ? 'p-6 min-h-[500px] rounded-lg ' : 'p-2 h-48 overflow-auto rounded scrollbar-hide'} ${theme === 'dark' ? 'bg-gradient-to-br from-gray-900 to-gray-800 text-white' : 'bg-gray-100 text-gray-800'}`}>
