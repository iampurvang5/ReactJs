    ...
    <div className={`w-full ${isDetailPage ? 'p-6 min-h-[600px] bg-gray-50 rounded-lg' : 'p-2 h-48 overflow-auto bg-gray-100 rounded scrollbar-hide'}`}>
      ...
      {isDetailPage && (
        ...
        <div className="mb-6 flex items-center gap-4">
            <label className="text-gray-700 font-medium">Insert Excel File:</label>
            <input
              type="file"
              accept=".xls,.xlsx"
            ...
            <table className="w-full bg-white rounded-lg shadow-md">
              ...
              <tbody>
                {data.map((row, index) => (
                  <tr
                    key={index}
                    className={`hover:bg-gray-50 transition duration-200 ${index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}`}
                  >
          ...
          <div className="mb-6 flex items-center gap-4">
            <label className="text-gray-700 font-medium">Select Chart:</label>
            <select
              value={selectedChart}
            ...
            <label className="text-gray-700 font-medium">Category Column:</label>
            <select
              value={nameKey}
