...
const DataTable = ({ isDetailPage = false }) => {
	...
	return (
	<div className={`container mx-auto ${theme === 'dark' ? 'bg-gradient-to-br from-gray-900 to-gray-800 text-white' : 'bg-gray-100 text-gray-800'} rounded ${isDetailPage ? 'px-4 py-8 min-h-[600px]' : 'px-2 py-4 h-48 overflow-auto'}`}>
		...
		<table className="min-w-full divide-y divide-gray-200">
			...
			<tbody className={`divide-y divide-gray-200 ${theme === 'dark' ? 'bg-gray-800 hover:bg-gray-900' : 'bg-white hover:bg-gray-50'}`}>
		...
		<div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
			<div className={`text-sm mb-4 sm:mb-0 ${theme === 'dark' ? 'text-gray-100':'text-gray-700'}`}>
