...
const SliderComponent = ({isDetailPage}) => {
	...
	return (
	<div className={`slider-container p-8 rounded ${isDetailPage ? 'min-h-[400px]' : 'h-48'} ${theme === 'dark' ? 'bg-gradient-to-br from-gray-900 to-gray-800 text-white' : 'bg-gray-100 text-gray-800'}`}>
		<Slider {...settings}>
